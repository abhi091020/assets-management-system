    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center p-4 bg-black/50">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl max-h-[92vh] flex flex-col">
        ...
        <div className="px-6 py-4 border-t border-gray-200 flex justify-end gap-3">
          ...
          {/* ★ Edit button — only shown when canManage and onEdit provided */}
          {canManage && onEdit && (
            <button
              onClick={() => { onClose(); onEdit(asset); }}
              className="px-5 py-2 text-sm font-semibold text-white bg-red-600 rounded-lg hover:bg-red-700 transition-colors flex items-center gap-2"
            >
